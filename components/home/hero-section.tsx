    ...
    <section className="relative overflow-hidden bg-primary py-24 md:py-32 lg:py-40">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto  text-center" >
          <p className="text-balance text-3xl font-bold tracking-tight text-primary-foreground sm:text-5xl lg:text-6xl">
            {t.hero.title}
          </p>
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="w-full border-primary-foreground/30 text-primary-foreground hover:foreground/10 sm:w-auto bg-transparent"
            >
              <Link href={getLocalizedHref('/contact')}>{t.hero.consultation}</Link>
            </Button>
          </div>
        </div>
      </div>
